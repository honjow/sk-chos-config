...
EMUDECK_GITHUB_URL="https://api.github.com/repos/an-anime-team/an-anime-game-launcher/releases/latest"
...
ICON_URL="https://raw.githubusercontent.com/an-anime-team/an-anime-game-launcher/main/assets/images/icon.png"
ICON_URL_CN="https://gitee.com/honjow/sk-holoiso-config/raw/master/assets/icons/an-anime-game-launcher.png"
...
icon_path=${tmp_dir}/an-anime-game-launcher.png
...
cp -f ${icon_path} ~/Applications/an-anime-game-launcher.png

echo "Downloading AppImage ......"
curl -L "${RELEASE_URL}" -o ${tmp_dir}/an-anime-game-launcher.AppImage --connect-timeout 10

echo "Installing an-anime-game-launcher $RELEASE_VERSION"
mv ${tmp_dir}/an-anime-game-launcher.AppImage ~/Applications/an-anime-game-launcher.AppImage
chmod +x ~/Applications/an-anime-game-launcher.AppImage


user_home=$(eval echo ~${SUDO_USER})

echo "Creating desktop shortcut"
cat > ${user_home}/.local/share/applications/an-anime-game-launcher.desktop <<EOL
[Desktop Entry]
Name=An Anime Game Launcher
Comment=An Launcher for a specific anime game with auto-patching, discord rpc and time tracking
Exec=${user_home}/Applications/an-anime-game-launcher.AppImage
Icon=${user_home}/Applications/an-anime-game-launcher.png
Terminal=false
Type=Application
Categories=Gaming;
Keywords=gaming;
